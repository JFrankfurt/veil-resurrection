            ...
            <aside className="w-64 border-r border-[rgb(var(--border-subtle))] p-6 flex flex-col bg-[rgb(var(--bg-card))]">
              <div className="mb-8">
                <Link href="/" className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-lg font-bold text-[rgb(var(--text-primary))]">Veil</span>
                    <span className="text-xs text-[rgb(var(--accent-primary))] block -mt-0.5 font-medium">Admin</span>
                  </div>
                </Link>
              </div>
